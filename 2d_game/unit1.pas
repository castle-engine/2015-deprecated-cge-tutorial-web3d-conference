...
procedure TForm1.Castle2DControl1Update(Sender: TObject);
  ...
  var
    MoveDistance: Single;
  begin
    MoveDistance := 1000 * Castle2DControl1.Fps.UpdateSecondsPassed;
...
begin
  ...
  Castle2DControl1.SceneManager.ProjectionHeight := 1442;

  DragonTransform := T3DTransform.Create(Application);
  DragonTransform.Scale := Vector3Single(0.2, 0.2, 0.2);
  DragonTransform.Translation := Vector3Single(0, 700, 0);
